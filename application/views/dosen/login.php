...
<head>
    ...
    <!-- Title Page-->
    <title>Login Dosen <?=SITE_NAME?></title>
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="<?= base_url()?>login_dosen/check" method="post">
                                <div class="form-group">
                                    <label> NIDN </label>
                                    <input class="au-input au-input--full" type="text" name="nidn" placeholder="masukan nidn dosen">
                                </div>
                                <div class="form-group">
