<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url()?>assets_admin/vendor/bootstrap.css"/>
    <link rel="stylesheet" type="text/css" href="<?= base_url()?>assets_admin/vendor/dataTables.bootstrap4.min.css"/>
