  ...
  <nav class="navbar navbar-expand navbar-dark bg-primary static-top">
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown <?= $aktif=='beria' ? 'active' : '' ?>">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="<?= base_url('berita/add') ?>">Add berita</a>
            <a class="dropdown-item" href="<?= base_url('berita') ?>">List berita</a>
          </div>
        </li>
      </ul>
        ...
        <div class="container-fluid">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
              ...
              <form action="<?php base_url('berita/add') ?>" method="post" enctype="multipart/form-data" >
              ...
              <div class="form-group">
                <select name="id_kategori" id="SelectLm" class="form-control" required="true">
                  ...
                  <?php for ($i=0; $i < count($kategoris) ; $i++) { 
                    ?>
                    <option value="<?=$kategoris[$i]->id_kategori?>" <?= $kategoris[$i]->id_kategori==$berita['id_kategori'] ? 'Selected' : ''?> ><?=$kategoris[$i]->nama_kategori?></option>
                  <?php } ?>
                </select>
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <textarea name="konten" id="ckeditor" class="form-control <?= form_error('konten') ? 'is-invalid':'' ?>"></textarea>
                <div class="invalid-feedback">
                  <?= form_error('konten') ?>
                </div>
              </div>
